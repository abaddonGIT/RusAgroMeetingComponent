...
Ext.extend(Meeting.grid.Items, OfficeExt.grid.Default, {
    windows: {},
        ...
        MODx.Ajax.request({
            ...
            listeners: {
                success: {
                    fn: function (r) {
                        var w = MODx.load({
                            xtype: 'meeting-item-window-update',
                            id: Ext.id(),
                            record: r,
                            listeners: {
                                success: {
    ...
    getColumns: function (config) {
        return [{
            ...
            header: _('meeting_item_active'),
            dataIndex: 'active',
            renderer: OfficeExt.utils.renderBoolean,
            sortable: true,
            width: 100,
        }, {
            header: _('meeting_grid_actions'),
            dataIndex: 'actions',
    ...
    getTopBar: function (config) {
        return [{
            text: '<i class="fa fa-plus"></i>&nbsp;' + _('meeting_item_create'),
