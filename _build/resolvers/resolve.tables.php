...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('meeting_core_path', null,
                    $modx->getOption('core_path') . 'components/meeting/') . 'model/';
            $modx->addPackage('meeting', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/meeting/model/schema/meeting.mysql.schema.xml';
